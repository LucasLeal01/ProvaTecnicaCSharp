<%@ Page Title="Funcionários" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Funcionarios.aspx.cs" Inherits="WebFormsUI.Funcionarios" Async="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-12">
            ...
            <div class="mb-3">
                <asp:Button ID="btnNovo" runat="server" Text="Novo Funcionário" CssClass="btn btn-primary" OnClick="btnNovo_Click" />
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvFuncionarios" runat="server" CssClass="table table-striped" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DataAdmissao" HeaderText="Data Admissão" DataFormatString="{0:dd/MM/yyyy}" />
                    ...
                    <asp:DetailsView ID="dvFuncionario" runat="server" CssClass="table table-bordered" 
                        ...
                        <Fields>
                            ...
                            <asp:BoundField DataField="Nome" HeaderText="Nome" />
                            <asp:BoundField DataField="Cargo" HeaderText="Cargo" />
                            <asp:BoundField DataField="DataAdmissao" HeaderText="Data Admissão" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false" />
