...
namespace WebFormsUI
{
    public partial class Funcionarios : Page
    {
        ...
        protected async void gvFuncionarios_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
        ...
        protected async void dvFuncionario_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
            try
            {
                var funcionario = new Funcionario
